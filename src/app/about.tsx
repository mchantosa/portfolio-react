        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-7 pt-4 pt-lg-0 content" data-aos="fade-left">
              <h3>
                Software Engineer, Fullstack Developer, Frontend, Backend, Web
                Developer &amp; Quality Assurance Engineer.
              </h3>
              <p className="fst-italic">
                I enjoy hiking, reading, pushups, cuddling my naked cat, fire
                pits, coffee, tea, good food, Star Trek, SciFi, Scrabble, and
                puzzles.
              </p>
              <div className="row">
                <div className="col-lg-6">
                  <ul>
                    <li>
                      ...
                      <strong>Degree:</strong> <span>MA Mathematics</span>
                    </li>
                    <li>
                      <i className="bi bi-chevron-right"></i>{" "}
                ...
                <div className="col-lg-6">
                  <ul>
                    ...
                    <li>
                      <i className="bi bi-chevron-right"></i>{" "}
                      <strong>Phone:</strong> <span>336-978-4359</span>
                    </li>
                    <li>
                      <i className="bi bi-chevron-right"></i>{" "}
                      <strong>City:</strong> <span>Seattle, WA</span>
                    </li>
                  </ul>
                </div>
              </div>
              <p>
                I am currently training AI through code evaluation and
                annotation with{" "}
                <a href="https://www.dataannotation.tech/" target="_blank">
                  DataAnnotation
                </a>
                . I also do freelance development on the side. Feel free to
                reach out if you have a project on which you would like to
                collaborate. Checkout my projects and portfolio for more
                information.
              </p>
            </div>
          </div>
